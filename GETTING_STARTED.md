...
6. Get connection string: `mongodb+srv://admin:PASSWORD@cluster.mongodb.net/career-web`

### Step 3: Configure Environment (1 minute)
Update `.env`:
```env
PORT=5000
MONGO_URI=mongodb+srv://admin:YOUR_PASSWORD@cluster.mongodb.net/career-web?retryWrites=true&w=majority
