      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-5xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-transparent text-4xl bg-clip-text bg-gradient-to-r from-primary to-purple-600">
             After 10th & 12th | CET / NEET / JEE | CAP Rounds
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/career-test" className="btn-primary text-lg">
              Take Career Test
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-8 text-gray-600">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium">10,000+ Students Guided</span>
            </div>
            <div className="flex items-center space-x-2">
              <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
